...
class MultiHeadedSelfAttention(nn.Module):
    ...
    def __init__(self, embedding_dim: int, attention_dim: int, num_heads: int):
        ...
        self.W_0 = nn.Linear(attention_dim, attention_dim, bias=False)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        concatenated = torch.cat([head(embedded) for head in self.heads], dim=2)
        return torch.round(self.W_0(concatenated), decimals=4)
